    ...
    <div class="formHeader">
            ...
            <form class='form' action="../accounts/index.php" method="post">
                <fieldset>
                    ...
                    <input type='text' name="userName" id="userName" class='input' required <?php if(isset($userName)){echo "value='$userName'";}  ?>><br>
                    <label for="userEmail">Email Address</label><br>
                    <input type='email' name="userEmail" id="userEmail" placeholder="example@gmail.com" class='input' required <?php if(isset($userEmail)){echo "value='$userEmail'";}  ?>><br>
