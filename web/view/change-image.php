    ...
    <main class="changeImageMain">
        <div>
            ...
            ?>
                    ...
                    ?>
                    <a href='../vinyl/index.php?action=editVinylNewPhoto&imageURL=<?php echo $imageURL; ?>'>Click here to return and continue editing the vinyl record</a><br>
